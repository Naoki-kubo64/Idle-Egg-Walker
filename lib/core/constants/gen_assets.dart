...
class GenAssets {
  ...
  // === 卵アセット ===
  static const String egg = '$_basePath/egg/egg_001.png';
  ...
  // === 背景アセット ===
  static const String backgroundDefault = '$_basePath/backgrounds/bg_default.png';
  static const String backgroundNight = '$_basePath/backgrounds/bg_night.png';
  static const String backgroundMorning = '$_basePath/backgrounds/bg_morning.png';
  ...
  static const List<int> availableMonsterIds = [1, 2, 3, 4, 5];
